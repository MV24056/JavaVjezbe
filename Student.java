...
public class Student {
	...
	public Student(String ime, String prezime, String brojIndexa, String adresa, float brojBodova, boolean polozioIliNe) {
		super();
		this.ime = ime;
		this.prezime = prezime;
		this.brojIndexa = brojIndexa;
	...
	public String toString() {
	 ...
	 public static ArrayList<Student> izdvojUlica (ArrayList<Student>niz, String ulica) {
		 ...
		 for (Student s:niz)
			 if(s.getAdresa().contains(ulica.toLowerCase()))
				 izdvojeno.add(s);
		 
		 return izdvojeno;
	 }
	 public static ArrayList<Student> izdvojProlazNaIspitu (ArrayList<Student>niz, boolean poloziliNisuPolozili) {
		 ArrayList<Student>izdvojeno = new ArrayList<>();
